...
IF OBJECT_ID ('powerschool.TR_course_enrollments_refresh_AI','TR') IS NOT NULL
   DROP TRIGGER powerschool.TR_course_enrollments_refresh_AI;
GO

CREATE TRIGGER powerschool.TR_course_enrollments_refresh_AI ON powerschool.fivetran_audit
  AFTER INSERT
AS
...
SET @view_name = 'course_enrollments'
