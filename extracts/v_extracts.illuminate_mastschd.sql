...
SELECT CONCAT(
      ...
      ,CASE WHEN tr.schoolid = 73253 THEN sec.expression ELSE sec.section_number END AS [06 Period]
...
FROM gabby.powerschool.terms tr
...
WHERE tr.yearid = (gabby.utilities.GLOBAL_ACADEMIC_YEAR() - 1990)
