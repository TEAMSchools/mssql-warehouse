...
CREATE OR ALTER VIEW payroll.salary_projection AS
  ...
  SELECT c.position_id
        ...
        ,ROW_NUMBER() OVER(
           PARTITION BY c.position_id
             ORDER BY c.pay_date DESC) AS rn_most_recent_paydate
...
SELECT r.position_id
      ...
      ,a.preferred_first
      ,a.preferred_last
FROM gabby.payroll.pr_employeesummary_clean r     
LEFT OUTER JOIN o
  ON r.position_id = o.position_id
 AND o.rn_most_recent_paydate = 1
LEFT OUTER JOIN gabby.adp.staff_roster a     
