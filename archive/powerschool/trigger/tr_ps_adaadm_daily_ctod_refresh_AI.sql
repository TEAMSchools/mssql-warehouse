USE gabby GO IF OBJECT_ID('powerschool.TR_ps_adaadm_daily_ctod_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER powerschool.TR_ps_adaadm_daily_ctod_refresh_AI;

GO CREATE
TRIGGER powerschool.TR_ps_adaadm_daily_ctod_refresh_AI ON powerschool.fivetran_audit AFTER
INSERT
...
SET
  @view_name = 'ps_adaadm_daily_ctod' BEGIN BEGIN try
