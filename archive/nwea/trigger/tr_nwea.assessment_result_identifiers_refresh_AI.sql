...
GO CREATE
TRIGGER nwea.TR_assessment_result_identifiers_refresh_AI ON nwea.fivetran_audit AFTER
INSERT
...
SET
  @schema_name = 'nwea'
SET
  @view_name = 'assessment_result_identifiers' BEGIN WAITFOR DELAY '00:01:00';
