...
CREATE OR ALTER VIEW tableau.compensation_report AS

WITH salary AS (
  SELECT pp.fiscal_year
        ,pp.year_part
        ,pp.month
        ,pp.pay_period
        ...
        ,ROW_NUMBER() OVER(
           PARTITION BY ea.df_employee_number, adp.adp_position_id, pp.fiscal_year, pp.month, pp.pay_period
