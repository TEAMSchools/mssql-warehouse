...
SELECT CAST(s.StudentNumber AS INT) AS student_number
      ,s.IsDC AS is_dc
      ,CAST(s.Application_Approval_Result_Description AS VARCHAR(25)) COLLATE Latin1_General_BIN AS application_approval_result_description
      ,CAST(s.EligibilityDescription AS VARCHAR(125)) COLLATE Latin1_General_BIN AS eligibility_description
      ,CAST(s.MealBenefitsStatusDescription AS VARCHAR(25)) COLLATE Latin1_General_BIN AS meal_benefits_status_description
