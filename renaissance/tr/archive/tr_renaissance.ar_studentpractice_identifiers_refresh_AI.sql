USE gabby GO IF OBJECT_ID('renaissance.TR_ar_studentpractice_identifiers_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER renaissance.TR_ar_studentpractice_identifiers_refresh_AI;

GO CREATE
TRIGGER renaissance.TR_ar_studentpractice_identifiers_refresh_AI ON renaissance.fivetran_audit AFTER
INSERT
...
SET
  @view_name = 'ar_studentpractice_identifiers' BEGIN WAITFOR DELAY '00:01:00';
