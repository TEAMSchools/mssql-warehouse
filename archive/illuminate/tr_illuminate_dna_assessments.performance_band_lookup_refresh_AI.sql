...
GO CREATE
OR ALTER
TRIGGER illuminate_dna_assessments.TR_performance_band_lookup_refresh_AI ON illuminate_dna_assessments.fivetran_audit AFTER
INSERT
...
SET
  @schema_name = 'illuminate_dna_assessments'
SET
  @view_name = 'performance_band_lookup' BEGIN BEGIN TRY
