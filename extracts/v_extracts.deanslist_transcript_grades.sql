...
WITH all_grades AS (
  SELECT s.student_number
        ...
        ,CASE WHEN sg.schoolname = 'KIPP Newark Collegiate Academy' THEN 'Newark Collegiate Academy'
          ELSE sg.schoolname
         END AS schoolname
        ,sg.storecode
        ,1 AS is_stored
  ...
  WHERE ISNULL(sg.excludefromtranscripts, 0) = 0
    AND sg.storecode = 'Y1'
  ...
  INNER JOIN gabby.powerschool.final_grades_static fg 
