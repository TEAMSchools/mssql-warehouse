USE gabby GO IF OBJECT_ID('nwea.TR_best_baseline_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER nwea.TR_best_baseline_refresh_AI;

GO CREATE
TRIGGER nwea.TR_best_baseline_refresh_AI ON nwea.fivetran_audit AFTER
INSERT
...
SET
  @schema_name = 'nwea'
SET
  @view_name = 'best_baseline' BEGIN WAITFOR DELAY '00:01:00';
...
WHERE
  ...
  AND table_name NOT IN ('percentile_norms');
