...
SELECT
  ...
  ISDATE(
    CAST([DP_Military] AS VARCHAR(10))
  ) AS [DP_Military],
  ISDATE(
    CAST([DP_Workforce] AS VARCHAR(10))
  ) AS [DP_Workforce],
  ISDATE(
    CAST([DP_Unknown] AS VARCHAR(10))
  ) AS [DP_Unknown],
  ...
  ISDATE(
    CAST([BGP_Military] AS VARCHAR(10))
  ) AS [BGP_Military],
  ISDATE(
    CAST([BGP_Workforce] AS VARCHAR(10))
  ) AS [BGP_Workforce],
  ISDATE(
    CAST([BGP_Unknown] AS VARCHAR(10))
  ) AS [BGP_Unknown],
