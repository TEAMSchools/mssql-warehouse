...
IF OBJECT_ID ('nwea.TR_best_baseline_refresh_AI','TR') IS NOT NULL
   DROP TRIGGER nwea.TR_best_baseline_refresh_AI;
GO

CREATE TRIGGER nwea.TR_best_baseline_refresh_AI ON nwea.fivetran_audit
  AFTER INSERT
AS
