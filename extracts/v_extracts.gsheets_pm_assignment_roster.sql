...
SELECT 
      ...
      /*default school_based assignments based on title/location*/
      ,CASE
        WHEN s.legal_entity_name <> 'KIPP TEAM and Family Schools Inc.' AND s.primary_site NOT IN ('Room 9 - 60 Park Pl', 'Room 10 - 121 Market St', 'Room 11 - 1951 NW 7th Ave') THEN 'school-based'
        END AS school_based
      /*default tntp assignments based on title/location*/
      ,CASE 
        ...
        WHEN s.primary_job IN ('Associate Director of School Operations','School Operations Manager') THEN 'ADSO'
