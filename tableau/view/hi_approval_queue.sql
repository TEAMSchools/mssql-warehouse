...
FROM
  ...
  LEFT JOIN gabby.deanslist.users AS u ON u.dluser_id = cf.[Approver name]
  AND u.[db_name] = cf.[db_name]
  INNER JOIN gabby.powerschool.cohort_identifiers_static AS co ON dli.student_school_id = co.student_number
