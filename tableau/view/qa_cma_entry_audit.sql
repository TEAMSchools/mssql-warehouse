...
SELECT s.local_student_id AS student_number
      ...
      ,co.team
      ,co.enroll_status
FROM gabby.illuminate_dna_assessments.student_assessment_scaffold_current_static saa
JOIN gabby.illuminate_public.students s
  ON saa.student_id = s.student_id
LEFT JOIN gabby.illuminate_dna_assessments.agg_student_responses o
  ON saa.student_id = o.student_id
 AND saa.assessment_id = o.assessment_id
LEFT JOIN gabby.reporting.reporting_terms rt
  ON saa.administered_at BETWEEN rt.[start_date] AND rt.end_date
