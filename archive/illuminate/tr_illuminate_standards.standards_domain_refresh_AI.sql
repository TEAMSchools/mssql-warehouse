USE gabby GO IF OBJECT_ID('illuminate_standards.TR_standards_domain_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER illuminate_standards.TR_standards_domain_refresh_AI;

GO CREATE
OR ALTER
TRIGGER illuminate_standards.TR_standards_domain_refresh_AI ON illuminate_standards.fivetran_audit AFTER
INSERT
...
SET
  @schema_name = 'illuminate_standards'
SET
  @view_name = 'standards_domain' BEGIN BEGIN TRY
