...
EXEC gabby.dbo.sp_generate_merge @table_name = 'student_assessment_scaffold_current_static', -- noqa: L016
...
EXEC gabby.dbo.sp_generate_merge @table_name = 'survey_response_data_options_current_static', -- noqa: L016
...
EXEC kippnewark.dbo.sp_generate_merge @table_name = 'cohort_identifiers_scaffold_current_static', -- noqa: L016
...
EXEC kippnewark.dbo.sp_generate_merge @table_name = 'course_section_scaffold_current_static', -- noqa: L016
...
EXEC kippnewark.dbo.sp_generate_merge @table_name = 'gradebook_assignments_current_static', -- noqa: L016
...
EXEC kippnewark.dbo.sp_generate_merge @table_name = 'gradebook_assignments_scores_current_static', -- noqa: L016
...
EXEC kippnewark.dbo.sp_generate_merge @table_name = 'ps_adaadm_daily_ctod_current_static', -- noqa: L016
...
EXEC kippnewark.dbo.sp_generate_merge @table_name = 'ps_attendance_daily_current_static', -- noqa: L016
...
EXEC kippnewark.dbo.sp_generate_merge @table_name = 'attendance_dashboard_current_static', -- noqa: L016
...
/*
-- INSERT INTO
--   [kippnewark].[powerschool].[course_enrollments_archive] (
--     [studentid],
--     [schoolid],
--     [termid],
--     [cc_id],
...
--   [rn_illuminate_subject]
-- FROM
--   [kippnewark].[powerschool].[course_enrollments_current_static];
--*/
/*
...
EXEC kippcamden.dbo.sp_generate_merge @table_name = 'cohort_identifiers_scaffold_current_static', -- noqa: L016
@target_table = 'cohort_identifiers_scaffold_archive',
@schema = 'powerschool',
@cols_to_join_on = "'student_number','date'",
@include_values = 0,
...
EXEC kippcamden.dbo.sp_generate_merge @table_name = 'course_section_scaffold_current_static', -- noqa: L016
@target_table = 'course_section_scaffold_archive',
@schema = 'powerschool',
@cols_to_join_on = "'studentid','yearid','sectionid','term_name','course_number','gradescaleid'", -- noqa: L016
@include_values = 0,
...
EXEC kippcamden.dbo.sp_generate_merge @table_name = 'gradebook_assignments_current_static', -- noqa: L016
@target_table = 'gradebook_assignments_archive',
@schema = 'powerschool',
@cols_to_join_on = "'assignmentsectionid'",
@include_values = 0,
...
EXEC kippcamden.dbo.sp_generate_merge @table_name = 'gradebook_assignments_scores_current_static', -- noqa: L016
@target_table = 'gradebook_assignments_scores_archive',
@schema = 'powerschool',
@cols_to_join_on = "'studentsdcid','assignmentsectionid','assignmentid'",
@include_values = 0,
...
EXEC kippcamden.dbo.sp_generate_merge @table_name = 'ps_adaadm_daily_ctod_current_static', -- noqa: L016
@target_table = 'ps_adaadm_daily_ctod_archive',
@schema = 'powerschool',
@cols_to_join_on = "'studentid','calendardate'",
@include_values = 0,
...
EXEC kippcamden.dbo.sp_generate_merge @table_name = 'ps_attendance_daily_current_static', -- noqa: L016
@target_table = 'ps_attendance_daily_archive',
@schema = 'powerschool',
@cols_to_join_on = "'id'",
@include_values = 0,
...
EXEC kippcamden.dbo.sp_generate_merge @table_name = 'attendance_dashboard_current_static', -- noqa: L016
@target_table = 'attendance_dashboard_archive',
@schema = 'tableau',
@cols_to_join_on = "'student_number','calendardate'",
@include_values = 0,
...
/*
-- INSERT INTO
--   [kippcamden].[powerschool].[course_enrollments_archive] (
--     [studentid],
--     [schoolid],
--     [termid],
--     [cc_id],
...
--   [rn_illuminate_subject]
-- FROM
--   [kippcamden].[powerschool].[course_enrollments_current_static];
--*/
/*
...
EXEC kippmiami.dbo.sp_generate_merge @table_name = 'cohort_identifiers_scaffold_current_static', -- noqa: L016
@target_table = 'cohort_identifiers_scaffold_archive',
@schema = 'powerschool',
@cols_to_join_on = "'student_number','date'",
@include_values = 0,
...
EXEC kippmiami.dbo.sp_generate_merge @table_name = 'course_section_scaffold_current_static', -- noqa: L016
@target_table = 'course_section_scaffold_archive',
@schema = 'powerschool',
@cols_to_join_on = "'studentid','yearid','sectionid','term_name','course_number','gradescaleid'", -- noqa: L016
@include_values = 0,
...
EXEC kippmiami.dbo.sp_generate_merge @table_name = 'gradebook_assignments_current_static', -- noqa: L016
@target_table = 'gradebook_assignments_archive',
@schema = 'powerschool',
@cols_to_join_on = "'assignmentsectionid'",
@include_values = 0,
...
EXEC kippmiami.dbo.sp_generate_merge @table_name = 'gradebook_assignments_scores_current_static', -- noqa: L016
@target_table = 'gradebook_assignments_scores_archive',
@schema = 'powerschool',
@cols_to_join_on = "'studentsdcid','assignmentsectionid','assignmentid'",
@include_values = 0,
...
EXEC kippmiami.dbo.sp_generate_merge @table_name = 'ps_adaadm_daily_ctod_current_static', -- noqa: L016
@target_table = 'ps_adaadm_daily_ctod_archive',
@schema = 'powerschool',
@cols_to_join_on = "'studentid','calendardate'",
@include_values = 0,
...
EXEC kippmiami.dbo.sp_generate_merge @table_name = 'attendance_dashboard_current_static', -- noqa: L016
@target_table = 'attendance_dashboard_archive',
@schema = 'tableau',
@cols_to_join_on = "'student_number','calendardate'",
@include_values = 0,
...
/*
-- INSERT INTO
--   [kippmiami].[powerschool].[course_enrollments_archive] (
--     [studentid],
--     [schoolid],
--     [termid],
--     [cc_id],
...
--   [rn_illuminate_subject]
-- FROM
--   [kippmiami].[powerschool].[course_enrollments_current_static];
--*/
/*
