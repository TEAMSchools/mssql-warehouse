...
CREATE OR ALTER VIEW extracts.deanslist_sight_words AS 

SELECT swd.local_student_id AS student_number
...
FROM gabby.illuminate_dna_repositories.sight_words_data_current_static swd
