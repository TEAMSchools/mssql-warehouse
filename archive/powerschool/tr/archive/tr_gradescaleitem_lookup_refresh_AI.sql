use gabby go if object_id('powerschool.TR_gradescaleitem_lookup_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER powerschool.TR_gradescaleitem_lookup_refresh_AI;

GO CREATE
TRIGGER powerschool.TR_gradescaleitem_lookup_refresh_AI ON powerschool.fivetran_audit AFTER
INSERT
...
set
  @view_name = 'gradescaleitem_lookup' begin begin try
