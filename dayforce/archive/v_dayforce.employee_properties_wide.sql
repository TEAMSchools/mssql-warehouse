         ...
         (
          SELECT CONVERT(VARCHAR(25), ep.employee_reference_code) AS employee_reference_code
                ...
                ,CONVERT(VARCHAR(25),LOWER(CASE
                                            ...
                                            WHEN ep.employee_property_value_name = 'Are you a TFA Corps Member or Alumni?'
                                                   THEN 'tfa_cm_or_alum'
                ...
                ,s.[status]
                ,s.primary_site
          FROM gabby.dayforce.employee_properties ep
          JOIN gabby.people.staff_crosswalk_static s
            ON ep.employee_reference_code = s.manager_df_employee_number
         ) sub
