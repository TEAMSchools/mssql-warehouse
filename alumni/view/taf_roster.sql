...
SELECT
  ...
  CAST(
    suf.release_1_name AS VARCHAR(125)
  ) AS ps_release_1_name,
  CAST(
    suf.release_1_phone AS VARCHAR(125)
  ) AS ps_release_1_phone,
  CAST(
    suf.release_1_relation AS VARCHAR(125)
  ) AS ps_release_1_relation,
  CAST(
    suf.release_2_name AS VARCHAR(125)
  ) AS ps_release_2_name,
  CAST(
    suf.release_2_phone AS VARCHAR(125)
  ) AS ps_release_2_phone,
  CAST(
    suf.release_2_relation AS VARCHAR(125)
  ) AS ps_release_2_relation,
  CAST(
    suf.release_3_name AS VARCHAR(125)
  ) AS ps_release_3_name,
  CAST(
    suf.release_3_phone AS VARCHAR(125)
  ) AS ps_release_3_phone,
  CAST(
    suf.release_3_relation AS VARCHAR(125)
  ) AS ps_release_3_relation,
  CAST(
    suf.release_4_name AS VARCHAR(125)
  ) AS ps_release_4_name,
  CAST(
    suf.release_4_phone AS VARCHAR(125)
  ) AS ps_release_4_phone,
  CAST(
    suf.release_4_relation AS VARCHAR(125)
  ) AS ps_release_4_relation,
  CAST(
    suf.release_5_name AS VARCHAR(125)
  ) AS ps_release_5_name,
  CAST(
    suf.release_5_phone AS VARCHAR(125)
  ) AS ps_release_5_phone,
  CAST(
