...
BEGIN
  ...
  -- only use tables we have synced
  */
  ...
  WHILE 1 = 1
    BEGIN
      ...
      /* 
      -- here's the beef, the query that the cursor is going to iterate over each repo ID, and INSERT INTO the temp table 
      */
      SET @query = N'
  ...
  */  
  ...
  ELSE  
    BEGIN
      ...
      MERGE illuminate_dna_repositories.repository_row_ids AS TARGET
