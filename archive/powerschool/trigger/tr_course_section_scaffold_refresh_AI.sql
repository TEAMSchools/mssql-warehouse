...
GO CREATE
TRIGGER powerschool.TR_course_section_scaffold_refresh_AI ON powerschool.fivetran_audit AFTER
INSERT
...
SET
  @view_name = 'course_section_scaffold' BEGIN BEGIN try
...
WHERE
  ...
  AND table_name <> 'reporting_terms';
