USE gabby GO IF OBJECT_ID('steptool.TR_component_scores_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER steptool.TR_component_scores_refresh_AI;

GO CREATE
OR ALTER
TRIGGER steptool.TR_component_scores_refresh_AI ON steptool.fivetran_audit AFTER
INSERT
...
SET
  @schema_name = 'steptool'
SET
  @view_name = 'component_scores' BEGIN BEGIN TRY
