...
CREATE OR ALTER VIEW
  tableau.covid_vaccine_dashboard AS
SELECT
  sc.df_employee_number,
...
FROM
  gabby.people.staff_crosswalk_static sc
  LEFT JOIN gabby.adp.vaccine_records vc ON sc.adp_associate_id = vc.associate_id
