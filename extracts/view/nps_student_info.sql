...
FROM
  ...
  LEFT JOIN kippnewark.powerschool.u_studentsuserfields AS suf ON co.students_dcid = suf.studentsdcid /* trunk-ignore(sqlfluff/L016) */
  LEFT JOIN kippnewark.powerschool.studentcorefields AS scf ON co.students_dcid = scf.studentsdcid /* trunk-ignore(sqlfluff/L016) */
  LEFT JOIN kippnewark.powerschool.student_contacts_wide_static AS scw ON co.student_number = scw.student_number /* trunk-ignore(sqlfluff/L016) */
