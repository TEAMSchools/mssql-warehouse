  ...
  range_scaffold AS (
    SELECT
      ...
      COALESCE(
        ...
        CASE
          WHEN d.source_system = 'DF' THEN '2020-12-31'
...
CASE 
     WHEN CAST(CURRENT_TIMESTAMP AS DATE) 
           BETWEEN r.effective_start_date 
                 AND r.effective_end_date 
           THEN 1 
ND AS is_current_record
,
  s.position_status,
