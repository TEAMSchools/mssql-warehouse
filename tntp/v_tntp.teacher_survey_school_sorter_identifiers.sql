...
CREATE OR ALTER VIEW tntp.teacher_survey_school_sorter_identifiers AS
...
SELECT school
      ...
      ,CASE
        WHEN school IN ('KIPP SPARK Academy', 'SPARK Academy','KIPP THRIVE Academy', 'THRIVE Academy','KIPP Seek Academy', 'Seek Academy'
                       ,'KIPP Life Academy', 'Life Academy - Lower', 'Life Academy - Upper', 'Life Academy at Bragaw','KIPP Lanning Square Primary'
                       ,'KIPP Lanning Square Primary School', 'Revolution Primary','KIPP Whittier Elementary','KIPP Pathways') 
                      THEN 'ES'
        WHEN school IN ('KIPP Rise Academy', 'Rise Academy','BOLD Academy', 'KIPP BOLD Academy','KIPP TEAM Academy'
                       ,'TEAM Academy','KIPP Lanning Square Middle School','KIPP Whittier Middle School') 
                      THEN 'MS'
        WHEN school IN ('KIPP Newark Collegiate Academy', 'Newark Collegiate Academy') THEN 'HS'
       END AS school_level
      ,CASE
        WHEN school IN ('KIPP Rise Academy', 'Rise Academy','KIPP Newark Collegiate Academy', 'Newark Collegiate Academy','KIPP SPARK Academy', 'SPARK Academy'
                       ,'KIPP THRIVE Academy', 'THRIVE Academy','KIPP Seek Academy', 'Seek Academy','KIPP Life Academy', 'Life Academy - Lower', 'Life Academy - Upper'
                       ,'Life Academy at Bragaw','BOLD Academy', 'KIPP BOLD Academy','KIPP Pathways','KIPP TEAM Academy', 'TEAM Academy') THEN 'TEAM'             
        WHEN school IN ('KIPP Lanning Square Primary', 'KIPP Lanning Square Primary School', 'Revolution Primary','KIPP Lanning Square Middle School'
                       ,'KIPP Whittier Middle School','KIPP Whittier Elementary') THEN 'KCNA'             
       END AS region
FROM
    (
     SELECT school
