...
CREATE OR ALTER VIEW tableau.staff_job_salary_audit AS
...
SELECT h.employee_number
      ...
      ,LAG(h.home_department,1) OVER( PARTITION BY h.employee_number ORDER BY h.effective_start_date ASC) AS prev_home_department
