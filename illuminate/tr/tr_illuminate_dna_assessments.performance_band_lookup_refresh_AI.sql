...
IF OBJECT_ID ('illuminate_dna_assessments.TR_performance_band_lookup_refresh_AI','TR') IS NOT NULL
...
SET @schema_name = 'illuminate_dna_assessments'
SET @view_name = 'performance_band_lookup'
...
BEGIN
  BEGIN TRY
    ...
    INTO #updated_tables
    FROM illuminate_dna_assessments.fivetran_audit WITH(NOLOCK)
