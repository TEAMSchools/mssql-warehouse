...
SELECT
  ...
  [AS24] AS [AS24_date],
  ISDATE(
    CAST([AS1] AS VARCHAR(10))
  ) AS [AS1],
  ISDATE(
    CAST([AS2] AS VARCHAR(10))
  ) AS [AS2],
  ISDATE(
    CAST([AS3] AS VARCHAR(10))
  ) AS [AS3],
  ISDATE(
    CAST([AS4] AS VARCHAR(10))
  ) AS [AS4],
  ISDATE(
    CAST([AS5] AS VARCHAR(10))
  ) AS [AS5],
  ISDATE(
    CAST([AS6] AS VARCHAR(10))
  ) AS [AS6],
  ISDATE(
    CAST([AS7] AS VARCHAR(10))
  ) AS [AS7],
  ISDATE(
    CAST([AS8] AS VARCHAR(10))
  ) AS [AS8],
  ISDATE(
    CAST([AS9] AS VARCHAR(10))
  ) AS [AS9],
  ISDATE(
    CAST([AS10] AS VARCHAR(10))
  ) AS [AS10],
  ISDATE(
    CAST([AS11] AS VARCHAR(10))
  ) AS [AS11],
  ISDATE(
    CAST([AS12] AS VARCHAR(10))
  ) AS [AS12],
  ISDATE(
    CAST([AS13] AS VARCHAR(10))
  ) AS [AS13],
  ISDATE(
    CAST([AS14] AS VARCHAR(10))
  ) AS [AS14],
  ISDATE(
    CAST([AS15] AS VARCHAR(10))
  ) AS [AS15],
  ISDATE(
    CAST([AS16] AS VARCHAR(10))
  ) AS [AS16],
  ISDATE(
    CAST([AS17] AS VARCHAR(10))
  ) AS [AS17],
  ISDATE(
    CAST([AS18] AS VARCHAR(10))
  ) AS [AS18],
  ISDATE(
    CAST([AS19] AS VARCHAR(10))
  ) AS [AS19],
  ISDATE(
    CAST([AS20] AS VARCHAR(10))
  ) AS [AS20],
  ISDATE(
    CAST([AS21] AS VARCHAR(10))
  ) AS [AS21],
  ISDATE(
    CAST([AS22] AS VARCHAR(10))
  ) AS [AS22],
  ISDATE(
    CAST([AS23] AS VARCHAR(10))
  ) AS [AS23],
  ISDATE(
    CAST([AS24] AS VARCHAR(10))
  ) AS [AS24],
  ISDATE(
    CAST([SC] AS VARCHAR(10))
  ) AS [SC],
  ISDATE(
    CAST([CCDM] AS VARCHAR(10))
  ) AS [CCDM],
  ISDATE(
    CAST([PSC] AS VARCHAR(10))
  ) AS [PSC],
  ISDATE(
    CAST([BBB] AS VARCHAR(10))
  ) AS [BBB],
  ISDATE(
    CAST([BM] AS VARCHAR(10))
  ) AS [BM],
  ISDATE(
    CAST([GP] AS VARCHAR(10))
  ) AS [GP],
  ISDATE(
    CAST([HV] AS VARCHAR(10))
  ) AS [HV],
  ISDATE(
    CAST([MC1] AS VARCHAR(10))
  ) AS [MC1],
  ISDATE(
    CAST([MC2] AS VARCHAR(10))
  ) AS [MC2],
  ISDATE(
    CAST(
      [DP_4year] AS VARCHAR(10)
    )
  ) AS [DP_4year],
  ISDATE(
    CAST(
      [DP_2year] AS VARCHAR(10)
    )
  ) AS [DP_2year],
  ISDATE(
    CAST(
      [DP_CTE] AS VARCHAR(10)
    )
  ) AS [DP_CTE],
  ISDATE(
    CAST(
      [DP_Military] AS VARCHAR(10)
    )
  ) AS [DP_Military],
  ISDATE(
    CAST(
      [DP_Workforce] AS VARCHAR(10)
    )
  ) AS [DP_Workforce],
  ISDATE(
    CAST(
      [DP_Unknown] AS VARCHAR(10)
    )
  ) AS [DP_Unknown],
  ISDATE(
    CAST(
      [BGP_4year] AS VARCHAR(10)
    )
  ) AS [BGP_4year],
  ISDATE(
    CAST(
      [BGP_2year] AS VARCHAR(10)
    )
  ) AS [BGP_2year],
  ISDATE(
    CAST(
      [BGP_CTE] AS VARCHAR(10)
    )
  ) AS [BGP_CTE],
  ISDATE(
    CAST(
      [BGP_Military] AS VARCHAR(10)
    )
  ) AS [BGP_Military],
  ISDATE(
    CAST(
      [BGP_Workforce] AS VARCHAR(10)
    )
  ) AS [BGP_Workforce],
  ISDATE(
    CAST(
      [BGP_Unknown] AS VARCHAR(10)
    )
  ) AS [BGP_Unknown],
  ISDATE(
    CAST([HD_P] AS VARCHAR(10))
  ) AS [HD_P],
  ISDATE(
    CAST(
      [HD_NR] AS VARCHAR(10)
