USE gabby GO IF OBJECT_ID('powerschool.TR_category_grades_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER powerschool.TR_category_grades_refresh_AI;

GO CREATE
TRIGGER powerschool.TR_category_grades_refresh_AI ON powerschool.fivetran_audit AFTER
INSERT
...
SET
  @view_name = 'category_grades' BEGIN BEGIN try
