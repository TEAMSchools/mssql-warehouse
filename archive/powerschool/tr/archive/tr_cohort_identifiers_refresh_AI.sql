use gabby go if object_id('powerschool.TR_cohort_identifiers_refresh_AI', 'TR') IS NOT NULL DROP
TRIGGER powerschool.TR_cohort_identifiers_refresh_AI;

GO CREATE
TRIGGER powerschool.TR_cohort_identifiers_refresh_AI ON powerschool.fivetran_audit AFTER
INSERT
...
set
  @view_name = 'cohort_identifiers' begin begin try
...
where
  ...
  and table_name not in (
    'njsmart_powerschool_kcna',
    'njsmart_powerschool_team',
    'adp_ps_id_link',
    'export_people_details'
  );
