...
CREATE OR ALTER VIEW payroll.finance_accounting_people_model AS
...
,teacher_goals AS (
  SELECT df_employee_number
        ...
        ,overall_tier
        ,CASE 
          WHEN academic_year <> gabby.utilities.GLOBAL_ACADEMIC_YEAR() AND pm_term = 'PM4' THEN 1
          WHEN academic_year <> gabby.utilities.GLOBAL_ACADEMIC_YEAR() AND pm_term <> 'PM4' THEN NULL
...
LEFT JOIN teacher_goals tg
  ON eh.employee_number = tg.df_employee_number
