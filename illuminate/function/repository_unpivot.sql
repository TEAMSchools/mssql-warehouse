...
SELECT
  @sql = CONCAT(
    'SELECT sub.repository_id, sub.repository_row_id, sub.[value], CAST(f.[label] AS NVARCHAR(32)) AS [label], s.local_student_id, CAST(r.date_administered AS DATE) AS date_administered',
    ' ',
    'FROM (',
    ' ',
