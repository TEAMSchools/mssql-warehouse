...
CREATE OR ALTER PROCEDURE tableau.merge_school_tactical_dashboard AS
...
WITH MySource AS (
  SELECT academic_year
        ...
        ,CASE
         ...
         END AS week_of_date
  FROM gabby.tableau.school_tactical_dashboard
  WHERE academic_year = gabby.utilities.GLOBAL_ACADEMIC_YEAR()
 )

MERGE gabby.tableau.school_tactical_dashboard_archive AS MyTarget
USING MySource
   ON MySource.academic_year = MyTarget.academic_year
