...
/****** Object:  Job [Scheduled | Refresh Static Views - PowerSchool (Hourly - 45's)]    Script Date: 8/25/2017 10:06:18 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 8/25/2017 10:06:18 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Scheduled | Refresh Static Views - PowerSchool (Hourly - 45''s)', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC gabby.utilities.cache_view 'powerschool', 'ps_adaadm_daily_ctod';]    Script Date: 8/25/2017 10:06:19 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'EXEC gabby.utilities.cache_view ''powerschool'', ''ps_adaadm_daily_ctod'';', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC gabby.utilities.cache_view 'powerschool', 'course_enrollments';]    Script Date: 8/25/2017 10:06:19 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'EXEC gabby.utilities.cache_view ''powerschool'', ''course_enrollments'';', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC gabby.utilities.cache_view 'powerschool', 'gradescaleitem_lookup';]    Script Date: 8/25/2017 10:06:19 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'EXEC gabby.utilities.cache_view ''powerschool'', ''gradescaleitem_lookup'';', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC gabby.utilities.cache_view 'powerschool', 'cohort_identifiers';]    Script Date: 8/25/2017 10:06:19 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'EXEC gabby.utilities.cache_view ''powerschool'', ''cohort_identifiers'';', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC gabby.utilities.cache_view 'powerschool', 'course_section_scaffold';]    Script Date: 8/25/2017 10:06:19 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'EXEC gabby.utilities.cache_view ''powerschool'', ''course_section_scaffold'';', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC gabby.utilities.cache_view 'powerschool', 'final_grades';]    Script Date: 8/25/2017 10:06:19 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'EXEC gabby.utilities.cache_view ''powerschool'', ''final_grades'';', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC gabby.utilities.cache_view 'powerschool', 'category_grades';]    Script Date: 8/25/2017 10:06:19 AM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Hourly - 45''s', 
		...
		@active_end_time=234600, 
		@schedule_uid=N'9d67b85e-f50d-4f32-bd03-a773db42daa6'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
