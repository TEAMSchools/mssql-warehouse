...
WITH
  salary_union AS (
    ...
    WHERE
      ...
      AND (
        '2021-01-01' (
          BETWEEN CAST(sh.regular_pay_effective_date AS DATE) AND COALESCE(
  ...
  COALESCE(
    ...
    DATEFROMPARTS(
      CASE
        ...
        AND DATEPART(MONTH, regular_pay_effective_date) >= 7 THEN DATEPART(YEAR, regular_pay_effective_date) + 1
