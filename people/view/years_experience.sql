...
SELECT
  d.employee_number,
  ROUND(
    d.days_active / 365.25,
    2
  ) AS years_active_at_kipp,
  ROUND(
    d.days_inactive / 365.25,
    2
  ) AS years_inactive_at_kipp,
  ROUND(
    d.days_active / 365.25,
    2
  ) + ROUND(
