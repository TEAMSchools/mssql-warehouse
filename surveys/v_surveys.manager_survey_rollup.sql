...
SELECT survey_title AS survey_type
      ...
      ,subject_primary_site_schoolid AS subject_primary_site_schoolid
      ,subject_primary_site_school_level AS subject_primary_site_school_level
