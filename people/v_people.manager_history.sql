...
FROM
    (
     ...
     JOIN gabby.adp.employees_all sre
      ...
      AND sre.file_number NOT IN (100814, 102496, 101652, 102634, 102641) /*  HR incapable of fixing these multiple employee numbers */
     JOIN gabby.adp.employees_all srm
       ON mh.reports_to_associate_id = srm.associate_id
      AND srm.file_number NOT IN (100814, 102496, 101652, 102634, 102641) /*  HR incapable of fixing these multiple employee numbers */
     ...
     JOIN gabby.adp.employees_all sre
      ...
      AND sre.file_number NOT IN (101640, 102602, 400011, 102641) /*  HR incapable of fixing these multiple employee numbers */
     JOIN gabby.adp.employees_all srm
       ON dm.manager_employee_number = srm.file_number
      AND srm.file_number NOT IN (101640, 102602, 400011, 102641) /*  HR incapable of fixing these multiple employee numbers */
