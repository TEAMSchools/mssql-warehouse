...
SELECT sub.assessment_id
      ...
      ,SUBSTRING(sub.title
                ...
                ,sub.module_number_length) AS module_number
    ...
    (
     SELECT a.assessment_id
           ...
           ,CASE
             ...
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9]/[0-9][0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_1 + '[0-9]/[0-9][0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9]/[0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_1 + '[0-9]/[0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9][0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_1 + '[0-9][0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_1 + '[0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9][0-9]/[0-9][0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_2 + '[0-9][0-9]/[0-9][0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9]/[0-9][0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_2 + '[0-9]/[0-9][0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9]/[0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_2 + '[0-9]/[0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9][0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_2 + '[0-9][0-9]%'
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9]%', a.title) > 0 
                  THEN '%' + n.module_number_pattern_2 + '[0-9]%'
            END AS module_number_pattern
           ,CASE
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9][0-9]/[0-9][0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_1) + 5
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9]/[0-9][0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_1) + 4
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9]/[0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_1) + 3
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9][0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_1) + 2
             WHEN PATINDEX('%' + n.module_number_pattern_1 + '[0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_1) + 1
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9][0-9]/[0-9][0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_2) + 5
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9]/[0-9][0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_2) + 4
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9]/[0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_2) + 3
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9][0-9]%', a.title) > 0 
                  THEN LEN(n.module_number_pattern_2) + 2
             WHEN PATINDEX('%' + n.module_number_pattern_2 + '[0-9]%', a.title) > 0 
