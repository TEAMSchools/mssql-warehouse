...
CREATE OR ALTER VIEW dayforce.employee_certification AS
     ...
     FROM
         (
          SELECT CONVERT(VARCHAR(25),employee_reference_code) AS employee_reference_code
                ...
                ,CONVERT(VARCHAR(25),LOWER(CASE WHEN employee_property_value_name = '(KIPP Miami) Do you have an ESOL Endorsement?' THEN	'miami_esol_endorsement'
                ...
                ,CONVERT(VARCHAR(25),property_value) AS property_value
...
PIVOT(
  MAX(property_value)
  FOR property_name IN ([miami_esol_endorsement]
                       ,[miami_statement_eligibility]
                       ,[miami_esol_expiry]
                       ,[miami_statement_eligibility_expiry]
                       ,[miami_ACES_number]
