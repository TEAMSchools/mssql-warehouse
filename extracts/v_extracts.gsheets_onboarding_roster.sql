...
SELECT jp.name AS job_position_name        
      ...
      ,CASE          
        WHEN CHARINDEX('_',jp.position_name_c) = 0 THEN jp.position_name_c          
       ...
       ,CONVERT(DATE,ja.hired_status_date_c) AS hired_status_date__c       
       ...
       ,CONVERT(DATE,jp.created_date) AS createddate
       ,CONVERT(DATE,jp.date_position_filled_c) AS date_position_filled__c
