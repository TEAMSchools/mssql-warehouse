...
SELECT id AS survey_campaign_id
      ...
      ,[name]
      ,[type]
      ,CAST(CASE WHEN link_open_date = '0000-00-00 00:00:00' THEN NULL ELSE link_open_date END AS DATETIME2) AS link_open_date
      ,CAST(CASE WHEN link_close_date = '0000-00-00 00:00:00' THEN NULL ELSE link_close_date END AS DATETIME2) AS link_close_date
      ,[status]
      ,close_message
