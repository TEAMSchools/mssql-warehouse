...
FROM asmts a  
LEFT JOIN gabby.illuminate_dna_assessments.agg_student_responses asr WITH(FORCESEEK)
...
JOIN gabby.illuminate_dna_assessments.assessment_standards astd WITH(FORCESEEK)
