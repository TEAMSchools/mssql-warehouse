...
SELECT DISTINCT
  ...
  ) + SUBSTRING(scaffold.subject, 2, LEN(scaffold.subject)) AS subject,
...
FROM
  ...
  INNER JOIN
      gabby.utilities.row_generator ON gabby.utilities.row_generator.n BETWEEN 9 AND 11
  /* UPDATE */
