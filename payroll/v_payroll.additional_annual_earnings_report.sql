...
JOIN gabby.people.employment_history_static eh
 ...
 AND DATEFROMPARTS(ade.academic_year,4,30) BETWEEN eh.effective_start_date AND eh.effective_end_date /*April 30 is the reporting date*/
JOIN gabby.people.staff_roster sr
